...
var _toNumberOrUndefined = _interopRequireDefault(require("../utils/toNumberOrUndefined"));
...
function Axis(_ref) {
  ...
  var format = tickFormat || (scale.tickFormat ? scale.tickFormat() : _toString.default);
  ...
  var axisIsHorizontal = isTop || orientation === _orientation.default.bottom;
  var tickSign = isLeft || isTop ? -1 : 1;
  var position = (0, _center.default)(scale.copy());
  ...
  if (children) {
    return _react.default.createElement(_group.Group, {
      ...
      ticks: values.map(function (value, index) {
        var scaledValue = (0, _toNumberOrUndefined.default)(position(value));
  ...
  return _react.default.createElement(_group.Group, {
    ...
    var scaledValue = (0, _toNumberOrUndefined.default)(position(val));
